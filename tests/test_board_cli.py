"""U8 integration — `tide status` / `tide arc status` / `tide cannon status` via the CLI."""
...
def test_cli_cannon_status_groups_by_state(in_project, capsys):
    cli.main(["arc", "new", "a1"])
